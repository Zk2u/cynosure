...
A lightweight, reference-counted smart pointer for single-threaded async executors that provides safe shared mutability without the overhead of `RefCell`.
